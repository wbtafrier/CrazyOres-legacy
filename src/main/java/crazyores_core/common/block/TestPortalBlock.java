...
import crazyores_core.common.world.dimension.DreamStateTeleporter;
...
public class TestPortalBlock extends BlockBreakable
{
	...
	{
		TestPortalBlock.Size size = new TestPortalBlock.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 1);
		TestPortalBlock.Size size1 = new TestPortalBlock.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 2);
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
	{
		...
		TestPortalBlock.Size size = new TestPortalBlock.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 1);
		TestPortalBlock.Size size1 = new TestPortalBlock.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 2);
	...
	public void onEntityCollidedWithBlock(World p_149670_1_, int p_149670_2_, int p_149670_3_, int p_149670_4_, Entity p_149670_5_)
	{
		...
		if ((p_149670_5_.ridingEntity == null) && (p_149670_5_.riddenByEntity == null) && ((p_149670_5_ instanceof EntityPlayerMP)))
		{
			...
			else if (thePlayer.dimension != DimensionList.dreamStateDimID)
			{
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, DimensionList.dreamStateDimID, new DreamStateTeleporter(thePlayer.mcServer.worldServerForDimension(DimensionList.dreamStateDimID)));
			}
			else {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new DreamStateTeleporter(thePlayer.mcServer.worldServerForDimension(0)));
			}
		}
	}
	...
	public static class Size
	{
		...
		public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_)
		{
			...
			this.field_150863_d = TestPortalBlock.field_150001_a[p_i45415_5_][0];
			this.field_150866_c = TestPortalBlock.field_150001_a[p_i45415_5_][1];
		...
		protected int func_150858_a()
		{
			...
			label56:
				...
				for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
				{
					...
					{
						k = this.field_150861_f.posX + j * Direction.offsetX[TestPortalBlock.field_150001_a[this.field_150865_b][1]];
						l = this.field_150861_f.posZ + j * Direction.offsetZ[TestPortalBlock.field_150001_a[this.field_150865_b][1]];
						...
						if (block == BlockList.test_portal)
						{
							++this.field_150864_e;
						}
						...
						if (j == 0)
						{
							block = this.field_150867_a.getBlock(k + Direction.offsetX[TestPortalBlock.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[TestPortalBlock.field_150001_a[this.field_150865_b][0]]);
						...
						{
							block = this.field_150867_a.getBlock(k + Direction.offsetX[TestPortalBlock.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[TestPortalBlock.field_150001_a[this.field_150865_b][1]]);
			...
			{
				j = this.field_150861_f.posX + i * Direction.offsetX[TestPortalBlock.field_150001_a[this.field_150865_b][1]];
				k = this.field_150861_f.posY + this.field_150862_g;
				l = this.field_150861_f.posZ + i * Direction.offsetZ[TestPortalBlock.field_150001_a[this.field_150865_b][1]];
		...
		{
			return p_150857_1_.getMaterial() == Material.air || p_150857_1_ == BlockList.test_portal;
		}
		...
		public void func_150859_c()
		{
			for (int i = 0; i < this.field_150868_h; ++i)
			{
				...
				for (int l = 0; l < this.field_150862_g; ++l)
				{
					...
					this.field_150867_a.setBlock(j, i1, k, BlockList.test_portal, this.field_150865_b, 2);
				}
			}
		}
	}
