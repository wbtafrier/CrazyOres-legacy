package crazyores_core.common.misc;
...
public class WorldGenEnd extends WorldGenerator
{
    private Block minableBlock;
    private int numberOfBlocks;

    public WorldGenEnd(Block var1, int var2)
    {
                    ...
                    for (int var41 = var33; var41 <= var36; ++var41)
                    {
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D)
                        {
                            for (int var44 = var34; var44 <= var37; ++var44)
                            {
                                ...
                                if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && var1.getBlock(var38, var41, var44).isAssociatedBlock(Blocks.end_stone))
                                {
                                    var1.setBlock(var38, var41, var44, this.minableBlock);
                                }
                            }
                        }
                    }
