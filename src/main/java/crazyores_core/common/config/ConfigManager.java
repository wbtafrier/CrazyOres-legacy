...
public class ConfigManager {
	...
	public static void writeFiles(FMLPreInitializationEvent event) {
		...
		CoreSettings.crystalGen = configFile.get(WORLD_GEN_CATEGORY, StatCollector.translateToLocal("config.node.generateCrystalOre"), true, StatCollector.translateToLocal("config.comment.generateCrystalOre")).getBoolean(true);
		...
		CoreSettings.demoniteGen = configFile.get(WORLD_GEN_CATEGORY, StatCollector.translateToLocal("config.node.generateDemoniteStone"), true, StatCollector.translateToLocal("config.comment.generateDemoniteStone")).getBoolean(true);
