...
public class SkyRenderer extends IRenderHandler {
	...
	private ResourceLocation moonPhaseTexture = new ResourceLocation("textures/environment/moon_phases.png");
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
        ...
        f10 = 50.0F;
        this.renderEngine.bindTexture(sunTexture);
        ...
        f10 = 33.3F;
        this.renderEngine.bindTexture(moonPhaseTexture);
