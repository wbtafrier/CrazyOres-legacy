...
public class RenderTapaziteGolem extends RenderGolems
{
	private static ResourceLocation golemLocation = new ResourceLocation(EntityNames.TAPAZITE_GOLEM_PATH);
	
	public RenderTapaziteGolem(ModelBase golem, String n)
	{
		super(golem, n);
	}
