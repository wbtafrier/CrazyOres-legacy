...
public class RenderSapphireGolem extends RenderGolems
{
	private static ResourceLocation golemLocation = new ResourceLocation(EntityNames.SAPPHIRE_GOLEM_PATH);
	
	public RenderSapphireGolem(ModelBase golem, String n)
	{
		super(golem, n);
	}
