...
public class CoreRenderArrow extends Render {
     ...
     */
    public void doRender(CoreEntityArrow p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
     ...
     */
    protected ResourceLocation getEntityTexture(CoreEntityArrow entity) {
    	
    	if (entity instanceof EntityFlamingArrow) {
    		return CoreResourceHandler.FLAMING_ARROW_TEXTURE;
    	}
    		...
    		return CoreResourceHandler.FREEZING_ARROW_TEXTURE;
    	}
    ...
    {
        return this.getEntityTexture((CoreEntityArrow)p_110775_1_);
    }
    ...
    {
        this.doRender((CoreEntityArrow)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
}