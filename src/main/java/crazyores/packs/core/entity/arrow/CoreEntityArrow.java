...
public class CoreEntityArrow extends EntityArrow implements IProjectile, IThrowableEntity{
    ...
    public CoreEntityArrow(World world, EntityLivingBase shootingEntity, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_) {
        ...
        double d0 = p_i1755_3_.posX - shootingEntity.posX;
        double d1 = p_i1755_3_.boundingBox.minY + (double)(p_i1755_3_.height / 3.0F) - this.posY;
        double d2 = p_i1755_3_.posZ - shootingEntity.posZ;
            ...
            if (movingobjectposition != null) {
                if (movingobjectposition.entityHit != null) {
                    ...
                    if (this.shootingEntity == null) {
                        damagesource = DamageSource.causeArrowDamage(new EntityArrow(this.worldObj), this);
                    }
                    else {
                        damagesource = DamageSource.causeArrowDamage(new EntityArrow(this.worldObj), this.shootingEntity);
                    }
    ...
    public void writeEntityToNBT(NBTTagCompound p_70014_1_) {
        p_70014_1_.setShort("xTile", (short)this.currentX);
        p_70014_1_.setShort("yTile", (short)this.currentY);
        p_70014_1_.setShort("zTile", (short)this.currentZ);
    ...
    public void readEntityFromNBT(NBTTagCompound nbt) {
        ...
        this.currentX = nbt.getShort("xTile");
        this.currentY = nbt.getShort("yTile");
        this.currentZ = nbt.getShort("zTile");
        this.ticksInGround = nbt.getShort("life");
        this.currentBlock = Block.getBlockById(nbt.getByte("inTile") & 255);
