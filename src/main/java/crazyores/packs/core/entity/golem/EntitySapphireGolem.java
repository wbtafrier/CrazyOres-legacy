...
public class EntitySapphireGolem extends EntityGolems {
	...
	public EntitySapphireGolem(World world) {
		super(world, 1.4f, 2.9f, EnumGolemType.SAPPHIRE);
	}
	
	public EntitySapphireGolem(World world, float scale) {
		super(world, 1.4f, 2.9f, scale, EnumGolemType.SAPPHIRE);
	}
	...
	protected void setAbilities() {
        ...
        this.targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityLiving.class, 0, false, true, new GolemTargets(EnumGolemType.SAPPHIRE).mobSelector));
	}
}
