...
public class EntityZectiumGolem extends EntityGolems {
	...
	public EntityZectiumGolem(World world) {
		super(world, 1.8f, 3.6f, EnumGolemType.ZECTIUM);
	}
	
	public EntityZectiumGolem(World world, float scale) {
		super(world, 1.8f, 3.6f, scale, EnumGolemType.ZECTIUM);
	}
	...
	protected void setAbilities() {
        ...
        this.targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityLiving.class, 0, false, true, new GolemTargets(EnumGolemType.ZECTIUM).mobSelector));
	}
}
