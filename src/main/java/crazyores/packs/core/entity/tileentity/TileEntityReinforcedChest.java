...
public class TileEntityReinforcedChest extends TileEntity implements IInventory {
    ...
    private int cachedReinforcedChestType;
    private String customName;
    private static final String __OBFID = "CL_00000346";

    public TileEntityReinforcedChest()
    {
        this.cachedReinforcedChestType = -1;
    }

    @SideOnly(Side.CLIENT)
    public TileEntityReinforcedChest(int p_i2350_1_)
    {
        this.cachedReinforcedChestType = p_i2350_1_;
    }
    ...
    {
        return this.hasCustomInventoryName() ? this.customName : "container.reinforced_chest";
    }
    ...
    private boolean func_145977_a(int p_145977_1_, int p_145977_2_, int p_145977_3_)
    {
        ...
        else
        {
            ...
            return block instanceof BlockReinforcedChest && ((BlockReinforcedChest)block).field_149956_a == this.func_145980_j();
        }
    }
    ...
    {
        if (this.getBlockType() instanceof BlockReinforcedChest)
        {
            --this.numPlayersUsing;
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1, this.numPlayersUsing);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
    ...
    {
        if (this.cachedReinforcedChestType == -1) {
            if (this.worldObj == null || !(this.getBlockType() instanceof BlockReinforcedChest)) {
                return 0;
            }

            this.cachedReinforcedChestType = ((BlockReinforcedChest)this.getBlockType()).field_149956_a;
        }

        return this.cachedReinforcedChestType;
    }
}
