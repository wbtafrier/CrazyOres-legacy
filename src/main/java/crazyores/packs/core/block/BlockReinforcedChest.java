...
public class BlockReinforcedChest extends BlockContainer implements IName {
    ...
    protected BlockReinforcedChest(String unlocalizedName, float hardness, float resistance) {
        super(Material.iron);
        this.field_149956_a = 0;
        unlocalizedBlockName = unlocalizedName;
    ...
    {
        TileEntityReinforcedChest TileEntityReinforcedChest = (TileEntityReinforcedChest)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);

        if (TileEntityReinforcedChest != null)
        {
            for (int i1 = 0; i1 < TileEntityReinforcedChest.getSizeInventory(); ++i1)
            {
                ItemStack itemstack = TileEntityReinforcedChest.getStackInSlot(i1);
    ...
    {
        Object object = (TileEntityReinforcedChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_);
    ...
    {
        TileEntityReinforcedChest TileEntityReinforcedChest = new TileEntityReinforcedChest();
        return TileEntityReinforcedChest;
    }
    ...
    public int isProvidingWeakPower(IBlockAccess p_149709_1_, int p_149709_2_, int p_149709_3_, int p_149709_4_, int p_149709_5_)
    {
        ...
        {
            int i1 = ((TileEntityReinforcedChest)p_149709_1_.getTileEntity(p_149709_2_, p_149709_3_, p_149709_4_)).numPlayersUsing;
	...
	public String getUnlocalizedName() {
		return unlocalizedBlockName;
	}
	
	@Override
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon(String.format("%s%s%s", COPackManager.corePack.getPackID(), ":", CoreBlocks.reinforcedBrick.getUnlocalizedName()));
	}
